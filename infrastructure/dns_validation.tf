...
# Define a local variable to reference the zone ID regardless of which source is used.
locals {
...
# Deduplicate certificate DNS validation records if there are duplicates.
locals {
